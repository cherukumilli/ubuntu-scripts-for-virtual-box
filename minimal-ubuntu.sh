...
wget https://raw.githubusercontent.com/cherukumilli/ubuntu-scripts-for-virtual-box/master/remove-amazon-util-using-ubuntu-terminal.sh &&
...
wget https://raw.githubusercontent.com/cherukumilli/ubuntu-scripts-for-virtual-box/master/uninstall-libreoffice-using-ubuntu-terminal.sh &&
...
wget https://raw.githubusercontent.com/cherukumilli/ubuntu-scripts-for-virtual-box/master/chrome-install-from-ubuntu-terminal.sh &&
...
wget https://raw.githubusercontent.com/cherukumilli/ubuntu-scripts-for-virtual-box/master/firefox-uninstall-using-ubuntu-terminal.sh &&
